...
export const futureDataComp: CompetitionArticleProps[] = [
  {
    ...
    lineData: [
      {
        content: "competition_section.data.future.1.info_line.1",
        icon: "calendar.svg",
        color: "dark",
      },
      {
        content: "competition_section.data.future.1.info_line.2",
        icon: "location-icon.svg",
        color: "dark",
      },
      {
        content: "competition_section.data.future.1.info_line.3",
        icon: "",
        color: "dark",
      },
    ],
  ...
  },
  {
    ...
    lineData: [
      {
        content: "competition_section.data.future.2.info_line.1",
        icon: "calendar.svg",
        color: "dark",
      },
      {
        content: "competition_section.data.future.2.info_line.2",
        icon: "location-icon.svg",
        color: "dark",
      },
      {
        content: "competition_section.data.future.2.info_line.3",
        icon: "",
        color: "dark",
      },
    ],
...
export const presentDataComp: CompetitionArticleProps[] = [
  {
    ...
    lineData: [
      {
        content: "competition_section.data.current.1.info_line.1",
        icon: "calendar.svg",
        color: "dark",
      },
      {
        content: "competition_section.data.current.1.info_line.2",
        icon: "location-icon.svg",
        color: "dark",
      },
      {
        content: "competition_section.data.current.1.info_line.3",
        icon: "",
        color: "dark",
      },
    ],
  ...
  },
  {
    ...
    lineData: [
      {
        content: "competition_section.data.current.2.info_line.1",
        icon: "calendar.svg",
        color: "dark",
      },
      {
        content: "competition_section.data.current.2.info_line.2",
        icon: "location-icon.svg",
        color: "dark",
      },
      {
        content: "competition_section.data.current.2.info_line.3",
        icon: "",
        color: "dark",
      },
    ],
...
export const pastDataComp: CompetitionArticleProps[] = [
  {
    ...
    lineData: [
      {
        content: "competition_section.data.past.1.info_line.1",
        icon: "calendar.svg",
        color: "dark",
      },
      {
        content: "competition_section.data.past.1.info_line.2",
        icon: "location-icon.svg",
        color: "dark",
      },
      {
        content: "competition_section.data.past.1.info_line.3",
        icon: "",
        color: "dark",
      },
    ],
...
export const competitionMap: CompetitionMapTypes = {
